...
module PantheonApi.Enum.ItemCategory exposing (..)
...
list =
    [ General, Schematic, Container, Clickie, Scroll, Potion, Ingredient, Food, Drink, Shield, Held, Jewellery, Relic, Catalyst, Component, Material, Reagent, Resource, ClothArmor, LeatherArmor, ChainArmor, PlateArmor, BladeWeapon, DaggerWeapon, StaveWeapon, SpearWeapon ]
